...
#
# The four plots that you will need to construct are shown below. (see original
# instructions post)
...
# The goal is not to deduct points over small deviations from the requirements
# or for legitimate differences in implementation styles, etc. Look for ways to
# give points when it's clear that the submitter has given a good faith effort
# to do the project, and when it's likely that they've succeeded. Most
# importantly, it's okay if a person did something differently from the way
# that you did it. The point is not to see if someone managed to match your
# way of doing things, but to see if someone objectively accomplished the task
# at hand.

# To that end, keep the following DO's and DON'Ts in mind: ####
#
# DO
#
#       Review the source code.
#       Keep an open mind and focus on the positive.≤/li>
#       When in doubt, err on the side of giving too many points, rather than
#             giving too few.
#       Ask yourself if a plot might answer a question for the person who
#             created it.
